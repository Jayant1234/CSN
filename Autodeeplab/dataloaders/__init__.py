from dataloaders.datasets import saltmarsh #, cityscapes, kd, coco, combine_dbs, pascal, sbd
...
def make_data_loader(args, **kwargs):
    if args.dist:
        ...
        if args.dataset == 'pascal':
            ...
            num_class = train_set.NUM_CLASSES
            train_loader = DataLoader(train_set, batch_size=args.batch_size, shuffle=True, **kwargs) #made drop last true because of non-divisible number with batch size.
            val_loader = DataLoader(val_set, batch_size=args.batch_size, shuffle=False, **kwargs)
            test_loader = None
            if args.autodeeplab == 'search':
                return train_loader,val_loader,val_loader, test_loader, num_class
